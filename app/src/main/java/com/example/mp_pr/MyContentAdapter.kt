...
class MyContentAdapter(val contentModel: ArrayList<ContentModel>) : RecyclerView.Adapter<MyContentAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyContentAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.my_page_content_item_view, parent, false)
    ...
    override fun onBindViewHolder(holder: MyContentAdapter.ViewHolder, position: Int) {
